...
- `Saving_North_Middletown_Elementary.pdf` - the 56-page report.
- `SaveNMES_Executive_Summary.pdf` - the four-page executive summary (built by `build/build_summary.py`).
- `NMES_Financial_Model.xlsx` - the 17-tab financial model (447 formulas).
