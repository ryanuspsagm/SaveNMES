...
put(kc, "A44", "BRACKET CHECK (v3.9): the record's plausible median vs this model's independent bottom-up median per displaced student. These bracket rather than coincide and measure different things: the record credits a district's whole budget change to its closure (an upper bound by construction), the model prices only the levers a closure moves. Before the v3.9 fixed-cost rebuild the model read $713 and the two nearly coincided. Both remain far below the plan's $6,957-$8,696 requirement."); put(kc, "B44", 818, BLUE, CUR); put(kc, "C44", "=Closure_Model!B47/Exodus_Model!B8", BLK, CUR, bold=True)
