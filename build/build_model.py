...
put(ex, "A19", "Band low (25th pct)"); put(ex, "B19", 0.50575, BLUE, NUM); put(ex, "C19", "=ROUND(B19*$B$8,0)", BLK, NUM); put(ex, "D19", "=ROUND(B19*$B$9*$B$15,0)", BLK, NUM); put(ex, "E19", "=B19*$B$9*$B$15*(Assumptions!B6+500)", BLK, CUR); put(ex, "F19", "Middle half of the corrected posterior; the closure grid's low leg", NOTE, wrap=True)
put(ex, "A20", "Median"); put(ex, "B20", 0.61425, BLUE, NUM); put(ex, "C20", "=ROUND(B20*$B$8,0)", BLK, NUM); put(ex, "D20", "=ROUND(B20*$B$9*$B$15,0)", BLK, NUM); put(ex, "E20", "=B20*$B$9*$B$15*(Assumptions!B6+500)", BLK, CUR); put(ex, "F20", "The closure grid's central leg and the calculator default", NOTE, wrap=True)
put(ex, "A21", "Band high (75th pct)"); put(ex, "B21", 0.71575, BLUE, NUM); put(ex, "C21", "=ROUND(B21*$B$8,0)", BLK, NUM); put(ex, "D21", "=ROUND(B21*$B$9*$B$15,0)", BLK, NUM); put(ex, "E21", "=B21*$B$9*$B$15*(Assumptions!B6+500)", BLK, CUR); put(ex, "F21", "The closure grid's high leg", NOTE, wrap=True)
put(ex, "A22", "95th percentile bound"); put(ex, "B22", 0.83375, BLUE, NUM); put(ex, "C22", "=ROUND(B22*$B$8,0)", BLK, NUM); put(ex, "D22", "=ROUND(B22*$B$9*$B$15,0)", BLK, NUM); put(ex, "E22", "=B22*$B$9*$B$15*(Assumptions!B6+500)", BLK, CUR); put(ex, "F22", "Not priced in the grid; the honest upper bound", NOTE, wrap=True)
