...
P("Since that comparison was first published, Fayette's audited figure has turned out to be the flattering "
  "one. On August 3, 2026 its board received an independent audit of budget processes and expenditures by "
  ...
  "budget, and below Fayette's own 6 percent administrative threshold. That is a <b>$21.5 million "
  "restatement</b> of a balance an audit signed in December 2025 had already reported, and it turns the "
  "$14.9 million drawdown into roughly <b>$36.4 million, about 5.3 cents of reserve burned per dollar "
  "spent</b> in a single year. Weaver traces the gap to unsupported and erroneous entries: a $3.5 million "
...
P("Read the two districts side by side and the lesson is runway rather than virtue. Bourbon burns about "
  "<b>4.2 cents of reserve per dollar spent</b> each year against Fayette's adjusted 5.3, a similar pace. "
  "What differs is depth: Bourbon holds 14.7 cents of cushion, roughly <b>three and a half years</b> at "
  "that pace, while Fayette holds about one cent and has approved borrowing up to $95 million to reach "
  "fall tax collections. Bourbon is not Fayette. It is pointed the same direction with time still on the "
  "clock, which is precisely why this board can still choose its own path rather than have one chosen for "
  "it. One further point belongs in the record, because it speaks directly to the choice in front of this "
  "board: Weaver wrote more than seventy recommendations and ten priority actions for a district in far "
  "worse condition than Bourbon County, and <b>not one of them is to close a school</b>. Every one concerns "
