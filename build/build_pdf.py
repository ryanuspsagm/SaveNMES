...
P("The capacity ratings themselves deserve the scrutiny they have never gotten, because the same three "
  ...
  "class-cap staffing added, $15,316 and $16,701; and even pricing every added student at $9,848, the actual "
  "per-student cost difference between the district's own two large schools on the same filing, $16,837 and "
...
P("This version also prices what earlier versions only named: the class-size caps that force the receiving "
  ...
  "of the district's one-dollar problem</b>, and 29 percent of scenarios lose money outright, before $100,000 "
...
fig("chart_closure_spectrum.png",
    "Figure 7. The honest range. Top: the net yearly effect of closure across all 1,944 combinations of the "
    "seven sourced inputs, from losing $385,000 to saving $565,000, with the middle half of scenarios between "
    "an $18,000 loss and a $200,000 saving and the median at a $91,000 saving. The plan's own $800,000 to "
...
P("The real breakeven question is the marginal one: at what enrollment do a school's students bring in more "
  ...
  "all-source costs divided by state-only revenue, says this school pays its way. One request follows: "
...
P("At the July 15, 2026 planning committee meeting, the superintendent stated that the district must free up "
  ...
  "which supports about $1.6 million of bonds. This report's two-tailed best case, $565,000, supports about $7.3 million, and its median, $91,000, about $1.2 million. "
...
P("Here is one concrete scenario, math anyone can check, run in the workbook's Redistricting tab. Rezone "
  ...
  "$176,000 published before this correction; across every slider corner it runs from minus $64,000 to "
  "$176,000. The move still cuts North Middletown's much-cited cost per student from $19,348 to about "
...
P("Name the problem correctly and the plan writes itself. Bourbon County Schools has a structural funding "
  ...
  "Middletown is not the reason salaries cannot increase; its honest excess cost is about $156,000 a year, "
  ...
  "option and delinquency recovery bring $370,000 to $500,000 in year one and about $1.0 to $1.1 million by "
  ...
  "risk, and any one of them alone outweighs the closure median of $91,000. Together they balance the "
...
tbl(["Request", "What it settles"],
    [["<b>The money.</b> The net-savings worksheet behind the \u201cover a million dollars\u201d statement",
      "Replaces the published two-tailed range, minus $385,000 to plus $565,000 (Sections 1, 4)"],
