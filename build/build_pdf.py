...
B("<b>Fact three: closing it frees very little.</b> Start from everything the district spent on the school "
  ...
  "guessed. The range runs from losing $1,020,613 a year to still losing $61,862. The median LOSES "
  "$534,433. Every one loses money (Section 4).")
...
tbl(["Estimate", "Basis", "Students missing each year", "SEEK lost each year"],
    [["Today's students", "47 to 69 percent of the 128 enrolled now", "61 to 88", "$312,104 to $453,447"],
     ["Steady state", "the same share of the whole feeder stream, middle half", "129 to 187", "<b>$661,579 to $961,189</b>"],
     ["Steady-state median", "the middle of the band", "159", "$814,868"]],
...
P("Read the signed evidence first: thirty-one households put their names on paper for seventy children. "
  ...
  "corrected for response bias. The middle half takes 61 to 88 of the 128 students enrolled today. "
  "Carried across the whole feeder stream, that keeps 129 to 187 students a year off the district's "
  "rolls, $661,579 to $961,189 a year. "
  "The children in the building carry about $6.2 to $6.9 million of remaining state funding through grade "
  "12 (1,339 student-years, priced at the $4,636 base to $5,136 with add-ons). About one in eight middle "
  ...
  "Close it and the middle case LOSES $534,433 a year.")
...
P("<b>Together, the plan is transformative.</b> With costs at the low end and the full restore, it clears "
  ...
  "certified teacher, on the $32 million of bonding capacity the district's own advisor presented in June "
  "2026, before a single leaked student comes back. Two recovered students close the difference. Recover "
...
P("Before any index or ranking, here is the primary record: the Kentucky Department of Education's "
  "school-level file for the 2024-25 Kentucky Summative Assessments, archived in this repository "
  "(build/kde_ksa_2024_25.json) so anyone can check it. On the state's own tests, North Middletown is first "
  "among all four elementary schools in Bourbon County, county district and Paris Independent alike, in "
  "every tested subject. It beats the <b>statewide</b> elementary average in science and writing.")
...
P("Here is the full arc, straight from the state's own files (Figure 1, top panel). Through the Unbridled "
  ...
  "excellent the year before. The component file is archived here.")
...
P("We keep the SchoolDigger index in Figure 1's lower panel and in Figure 2 only as outside context, with "
  ...
  "school this size, and it named the wrong county leader in three of the ten years both sources cover. "
  "Wherever the index and the official record disagree, the official record governs.")
...
P("North Middletown's $19,348 per student is the highest of the three elementaries. That is exactly "
  ...
  "allocated figure, not a site ledger. On the same 2023-24 basis the report showed $2,611,980 for North "
  "Middletown (its $19,348 rate at the 135 students then reported; at today's 128 the same rate gives "
  "the $2,476,544 the cost case rests on), while the district's working budget coded $1,593,309 to the "
  "school that year, about $1.0 million less. The difference is central office, district transportation "
  "and district instructional support that no closure removes. And almost none of that total is what a "
...
P("The capacity ratings deserve scrutiny they have never gotten. The same three unchanged buildings have "
  ...
  "then the draft's 154; Bourbon Central 564, 611, 521, 640; Cane Ridge 500, 550, 422, 547, with no major "
  "construction at any of the three after 2009. Ratings that swing by up to 128 seats between cycles are "
  "policy choices, not walls. The cost conclusion is validated against actuals two ways. At bare supplies "
...
P("The 128 children would still need teachers, about six homerooms' worth (eight to nine certified "
  ...
  "that some families leave the district altogether. Each departure takes at least $4,636 a year in "
...
P("First, the staffing price, stated plainly. $85,000 is the right all-in figure for comparing spending "
  "filings, but the wrong figure for the General Fund: Kentucky pays teacher retirement and health "
  "insurance on behalf of districts, so the General Fund keeps only salary plus roughly five percent "
  "when a position goes away: <b>$50,000 to $75,000 per position, not $85,000</b>. We go further and "
...
P("The grid is built on the district's 48-page response and the community's survey. Six levers, each "
  ...
  "school-choice survey at steady state (129 to 187, Section 5: the band's 25th, 50th, and 75th "
  "percentiles, triangular with the median central; the signed-survey floor of 74, the 31 households "
  "alone, sits below every priced leg as hard evidence, not a scenario). Five: each missing student "
  "costs the enacted FY2027 SEEK base of $4,636 plus up to $1,000 of add-ons, minus the $400 of "
  "supplies that stop, the same figure the growth model charges each recruit; teacher savings appear "
  "ONLY on the teachers-cut lever, so staffing is never counted twice. Six: the added busing a "
  "110-square-mile zone requires, its high leg capped at half the bottom-up maximum. A property-value "
  ...
  "yearly effect falls between <b>losing $1,020,613 and still losing $61,862</b>. The middle half of "
  "weighted scenarios lands between a $643,405 and a $429,974 loss. The median outcome <b>LOSES "
  "$534,433 a year</b>, and every priced scenario loses money outright, before $100,000 to $300,000 of "
  "one-time transition costs in year one (unweighted, the median is a $530,476 loss; no conclusion "
...
fig("chart_closure_spectrum.png",
    "Figure 5. The honest range. Top: the net yearly effect of closure across all 972 combinations of the "
    "six sourced inputs, from losing $1,020,613 to still losing $61,862, with the middle half of weighted scenarios "
    "between a $643,405 and a $429,974 loss and the median at a $534,433 loss. The plan's own $800,000 to "
...
P("In early August 2026 the community asked NMES families the question the district's plan never prices: "
  "if the school closes, what would your family actually do? Forty-two responses came in. Counting one "
  "further family with one child received after the form closed, <b>38 households answered for 85 "
  "children.</b> Duplicates were removed by hand, three households known to be staying were recoded, "
  "and one family that already left the district was set aside. The cleaned result: <b>31 households, "
  ...
  "(the surveyed children include current students, younger siblings, and children not yet in school, "
  "so the share expresses scale, not a headcount of current students). Where would they go? Montgomery "
  "County Schools 25, other or undecided 20, homeschool 16, private school 8, Clark County Schools 1. "
  "The other-or-undecided count includes seven children marked with a public school in this district; "
...
P("Their named destinations are real and open today: Montgomery County, Clark County, homeschool, "
  ...
  "per-class floor). A child who leaves is missing for every remaining grade. The district's "
  "grade-to-grade records show 97 to 100 percent of county fifth graders enter its middle school and "
...
P("The statistical estimate corrects the survey for the obvious bias: families set on leaving answer a "
  "survey like this more readily than families staying put. Among currently enrolled surveyed children "
  "the raw split is 20 leavers to 4 stayers, about a fifth of the school. A response-propensity model "
  "discounts that split across leaver-to-stayer response ratios from about 1x to 9x, centered on 3.5x. "
  "The result puts the true leave share at a median of 61 percent, middle half 51 to 72 percent. "
  "Applied to the 128 students enrolled today, that is <b>61 to 88 children in the building right "
  "now</b>. Extended to the entire NMES feeder stream, each entering class of about 22 (ten-year SAAR "
  "kindergarten average 22.2; recent per-grade range 19 to 24) carried for 12.62 effective years, it is "
  "<b>129 to 187 students missing from the rolls each year at steady state, $661,579 to $961,189 a "
  "year</b>, with a 95th-percentile bound near $1.14 million. Losses build from six grade cohorts in "
  "year one to all thirteen by year eight. build/exodus_model.py reproduces every number from the "
  "published anonymized data. The 1x-to-8x correction range is anchored to published measurements of "
  "exactly this bias, all in Sources: Groves, Presser, and Dipko (Public Opinion Quarterly, 2004) "
  "measured interested groups answering 1.4 times more readily; Abraham, Helms, and Presser (American "
  "Journal of Sociology, 2009) measured engaged people answering a follow-up survey 1.35 times more "
  "readily; Pew Research Center's benchmark studies (2012, 2017) find civically engaged people "
  "over-represented at implied ratios of roughly 3 to 4. That measured band, 1.4x to 4x, sits inside "
  "the model's 1x to 9x span, and the central 3.5x is pitched at the top of the published record on "
  "purpose: a small, emotionally charged pool answering a zero-effort form circulated by the campaign "
  "itself is exactly where this bias runs strongest, so the model leans against its own survey.")
P("The state's own files corroborate the band from outside the survey. The SAAR school-level enrollment "
  "reports, archived here, show NMES ending 2023-24 with 141 students, 2024-25 with 128, and 2025-26 "
  "with 115, and this year's kindergarten enrolled <b>12 children against a norm of 21 to 31</b>: the "
  "front-door defection the survey predicts, already visible in the district's own state filings before "
  "any closure vote. One label is corrected in this release: the facility plan's '128', previously "
  "described as the district's 2023-24 SAAR figure, matches the state's 2024-25 SAAR end-of-year "
  "membership file exactly (as does Cane Ridge's 461), and end-of-year enrollment is the planning "
  "manual's own basis; the state's 2023-24 file shows 141.")
P("Where inter-district choice is already open, the aftermath is on the record. Council Bluffs, Iowa "
  ...
  "up to 40 percent of its students to open enrollment and its board voted to dissolve the district. "
...
P("Leaving is not pure loss, and the model credits the savings without double counting. Each missing "
  "student stops costing about $400 in supplies, the same low-leg figure the growth model charges each "
  "recruit, and the credit scales with every child who goes. Cutting teachers is a separate decision, "
  "priced only on the teachers-cut lever, the district's own 0 to 3 positions. Even with both credits "
  "at their friendliest, every priced scenario loses money. $400 of supplies and a few positions cannot "
  "outrun $5,136 walking out with every child.")
...
P("The 300-student breakeven, and every version of the cost case against this school, rests on "
  ...
  "a difference of $1,018,671 in central office, district transportation, the maintenance pool and "
...
P("The working budget's location view cuts against this report in one place. Measured on all dollars "
  ...
  "Central: premiums of 9.6 and 12.2 percent, against 3.6 and 6.7 percent on the federal all-in basis. "
...
P("Of the $1,706,493 coded to the school, on-behalf payments ($406,333) are not district cash, federal "
  ...
  "transaction detail archived here, shows what the school actually spent from it in fiscal 2026: "
  "<b>$933,537</b>, within 0.55 percent of the working budget's $938,690, most of it teacher salary "
  "payable again at the receiving school. By function: regular classroom instruction $474,956; other "
...
P("The district's response prices closure savings at “$661,138.94 MINIMUM.” Take it apart block by "
  ...
  "leaving (13 students at $5,136 each is $66,768 a year of state money). And the analysis behind the "
...
P("Two conclusions follow. First, the closure model estimated the school's avoidable fixed base at "
  ...
  "earlier working-budget program view), and every fixed line including the library totals "
  "<b>$293,316</b> on the ledger ($276,928 on the budget view): both estimates land within seven "
  "percent of the measured record. Second, <b>$230,000 is the floor of the grid, not a floor case</b>: "
  ...
  "adds the variable-cost-shed lever: 972 scenarios, median a $534,433 yearly loss, every one losing "
  "money.")
P("There is a limit to what any ledger can settle. The eight inputs that decide a closure's net effect "
  "span about $950,000. The district's books speak to two of them, worth about a third of that spread. "
...
P("Millersburg Elementary, about nine road miles from Paris, closed in 2006 with a final enrollment of "
  ...
  "addition the district's own facility plan dates to 2007. What happened next is on the census rolls, "
  "Figure 6: Millersburg fell from 842 people in 2000 to 792 in 2010 to 747 in 2020, down 11 percent, "
  "while the county grew 4.6 percent. No single closure did that alone: the private Millersburg Military "
  "Institute shut permanently the same July, and the Joy Global plant followed in 2013, taking 197 jobs "
  "and, by the town's own accounting, half its operating budget. That is the honest lesson, and it is "
  "worse, not better: small towns lose their anchors in cascades, each loss making the next more likely. "
  "Twenty years later the district is over capacity at the school that absorbed Millersburg's children "
  "and proposes to solve it by closing another small school. North Middletown's attendance zone holds "
  "2,625 people. The records ask writes itself: produce the savings analysis from the 2006 closure and "
  "the savings actually realized, before the same projection is made again.")
...
P("<b>First, the money.</b> For the 163 closure events with clean finance data, we compared each "
  ...
  "student. The median closure produced <b>$1,102 per displaced "
  "student</b> ($818 among the physically plausible cases), and <b>40 percent of districts spent MORE "
  "than trend after closing</b>. Both tails hold events beyond $13,000 per child, more than any school "
  "costs to run per student: budget-wide noise, not closure effects. The raw median for the 27 closures "
  "most like this plan prints $8,440; it is the same artifact, and inside the plausible window that "
  "median is <b>$541</b>. The yardstick: this plan needs <b>$6,250 to $7,813 per displaced child</b>, "
  "above the record's 75th percentile. Among rural elementary closures the one clean comparable with "
  "nothing built, Webster County's closure of Slaughters Elementary in 2012, paid $3,525; every case at "
  "or near the plan's number came with a new school (Perry 2017, Adair 2006, Metcalfe 2013) or was a city "
  "or county-seat grade reshuffle. The record's figure credits a district's entire budget change to its "
  "closure, an upper bound by construction. Our bottom-up model prices only the levers a closure moves, "
  "and its current median is a $534,433 yearly LOSS, about $4,175 per displaced student below zero. The "
  "plan's requirement is eight times the record's median and unreachable by our own model, whose best "
  "case is itself a $483-per-displaced-student loss.")
...
P("<b>Second, the classrooms.</b> Test scores can only be compared within one accountability system, so "
  ...
  "twenty-one were flat: a wash, median half a point down. The pattern inside the wash points one way: "
  "the more children a closure displaced, the worse the trend. The improvers were overwhelmingly small "
  "closures inside eastern Kentucky's broad mid-decade testing rebound, gains far too large for schools "
  "that were one to eight percent of their districts to explain. Exactly <b>one</b> event in the record "
  "shows both clear savings and clear gains: Leslie County 2013, which folded its middle school into an "
  "existing campus in the same community. No case shows a district closing a rural town's elementary "
  "school, clearly saving money, and clearly improving scores.")

P("<b>Third, the two best cases, disclosed by us so no one has to discover them.</b> Perry County closed "
  "three rural elementaries in 2017 and shows real, modest savings, about $3,600 per displaced student, "
  "with scores continuing an earlier climb; it did so by building the new West Perry Elementary for the "
  ...
  "savings this plan requires, and none for academic improvement from a closure like this one. If the "
...
P("When the numbers are shown in public, four distinctions will help everyone read them the same way, "
  "because each can quietly make closure look better than it is: gross site cost presented as savings; "
  "restricted building dollars presented as operating relief; per-pupil cost cited without noting that "
  "state funding follows the student; and district-wide cost growth attributed to one small school. We "
  "flag our own judgment calls where they occur.")
P("Whatever the true net number proves to be, one comparison frames the decision on either honest "
  "yardstick. Against the $2.6 million structural deficit before transfers, closing North Middletown "
  "addresses at best a small fraction. Against the roughly $1.15 million the district actually draws "
  "from reserves each year, even the fullest documented case reaches about forty percent. Either way it "
...
P("At the same time, several costs the district controls grew quickly: a two-percent raise in fiscal "
  "2024 with \u201csome employees receiving much more,\u201d in the audit's own words, step increases in fiscal "
  "2025, transportation up 20.3 percent in a single year, and central-office administration up 44.8 "
  "percent in two years (Section 9). A $6.055 million bond issued in 2024 helped push debt-service "
  "payments up about $430,000 this year (Section 8).")
...
P("Both districts' fiscal 2025 statements carry clean audit opinions. Hold them to the same fiscal "
  ...
  "dollar</b> ($4,290,840) against Fayette's <b>4.1 cents</b> ($28,361,786), after Fayette's balance "
  "fell another $14.9 million, from $43.3 million to $28.4 million, in a year its budget book had "
  "planned to hold the fund flat.")
P("Fayette's figures moved after that audit. On August 3, 2026 its board received an independent audit "
  ...
  "percent</b> of $690,460,223 of General Fund spending: below the 2 percent minimum reserve KRS "
  "160.470(6)(a) requires every Kentucky district to budget, and below Fayette's own 6 percent "
...
P("How long each cushion lasts depends on the burn rate used. Bourbon's fund balance fell $1,225,465 "
  ...
  "on the operating basis ran 5.7 cents against a 4.1-cent cushion, under a year, and on Weaver's "
  "unaudited view nearer one cent; it has approved borrowing up to $95 million to reach fall tax "
  "collections. Both districts' net-change figures are held down by transfers in, so both are restated "
  "on the operating basis and measured the same way. One more item belongs in the record: Weaver's "
...
P("In June 2026 the district's financial advisor, Robert W. Baird and Co., presented the bonding "
  ...
  "unexpired SFCC offers of assistance that expire between January 2028 and January 2034 (the "
  "components print $501 over the stated total, Baird's own rounding). Current bonding capacity: <b>$32 "
  ...
  "restricted streams, a different conversion from the General Fund bond multiplier used elsewhere, so "
  "the two rates are not comparable). Second, the presentation is built on the state's 2026-27 SEEK "
...
P("As the 2024 issue and the other series settle in, total debt service steps up about $430,000, from "
  "$1.15 million in fiscal 2025 to $1.58 million in fiscal 2026 (the net change across all seven "
  "series, some rising and the 2013 issue maturing, not the 2024 bond's payment alone). The SFCC pays "
...
P("The district's own KDE Budget Monitoring Tool, in the June 2026 packet on the board's July 16 agenda "
  "and archived in this repository, shows fiscal 2026 closing down roughly $374,000, the best result in "
  "three years, against audited drawdowns of $1.07 million and $1.23 million in the two years before. "
  "The same packet shows how that headline was built. Two June entries account for nearly all of it: a "
  "$1,320,939 transfer of restricted capital money into the general fund (lawful, through a Capital "
  "Funds Request, and precisely the sweep the growth plan would end) and a $1,413,929 receipt booked to "
  "miscellaneous revenue in period 12 against a budget of zero. The packet's variance row reconciles to "
  "the dollar. The genuine improvements are real but modest: SEEK revenue $402,000 over budget and "
...
P("<b>Administrative salaries went down, not up.</b> Over the window the ledger covers, salaries in the "
  ...
  "leave to a lump sum; it is coded to central office because that is where payroll clears, not because "
  "central office grew, and it is a retirement cost for staff across the district. Purchased "
...
P("Every option below is available under current Kentucky law, and each comes with the question the "
  "administration should answer about it. Dollar values are planning estimates from the audited base "
...
P("The strongest alternative is not defensive. Kentucky law already gives the district a way to grow. "
  ...
  "for SEEK funding, with no agreement from the child's home district required and tuition at the "
  "board's discretion. Every family North Middletown attracts brings at least the $4,636 base "
...
P("North Middletown is built to compete for those families. It is a 2011 National Blue Ribbon school "
  "with a gifted-and-talented program, a 13.6-to-1 student-teacher ratio, state results that lead every "
  "elementary school in Bourbon County in every state-reported subject, and a third-party index that "
  ...
  "supplies and about $134,000 if they require the added section this version prices, before tuition, "
  "add-ons, or the further growth a signature program (advanced learners is one natural fit), a "
  "preschool satellite, and a serious marketing effort could generate along the U.S. 460 corridor, "
  "within a short drive of five surrounding counties. The question for the administration: why is the "
  "district's only nationally honored school proposed for reclassification instead of expansion?")
...
P("But a school's enrollment does not have to wait on a county's birth rate, because the board controls "
  ...
  "board's to draw, and with Bourbon Central at 459 students and Cane Ridge at 453 while the district's "
  "best elementary sits at 128 of a rated 174, redrawing the eastern edges, starting with families who "
  "already live closer to North Middletown than to their assigned school, would fill its open seats with "
  "children the district already educates, relieve the crowded Paris schools, and shorten those "
  "children's rides. The second is the county's edges. Under House Bill 563, families just across the "
...
P("The seats deserve a destination, not just a headcount. One natural path is a specialized program for "
  "advanced learners that families apply into from across the district and, under House Bill 563, from "
  "the surrounding counties; Kentucky's larger districts have run magnet schools for decades because a "
  ...
  "the school enrolled as recently as 2020-21 (166 in 2019-20) takes just 32 children from a district of "
...
P("The decline itself deserves questions, not just measurement, because its milestones track the "
  ...
  "Paris center, so many zone families now start their school lives in Paris; the renovation priced in "
  "2013 reappears in the 2021 plan, priced higher; the rated capacity was written down from 198 to 174; "
  "and no public recruitment or transfer program has marketed the county's highest-scoring elementary "
  "to anyone. Each of those is a district decision, not a demographic fact. A school 93 percent full "
...
P("Every one of those children is a Bourbon County child whose family already chose something else, and "
  "the state pays $4,636 for each one who returns. Filling North Middletown's 46 open seats takes about "
...
P("The students are not hypothetical. The public record measures the pool three ways, all archived "
  ...
  "with the local superintendent (KRS 159.160), and the counts the districts reported, collected by the "
  ...
  "shows that group roughly doubling since the 2014-2018 window. An earlier version of this report put "
  "it at about one in three of the county's school-age children from the survey alone; that was too "
  "high, inflated by a small-sample weighting artifact in one age band. Reconciling the district "
...
P("The revenue side is symmetric with the closure math in Section 4, on purpose, using the same $4,636 "
  "SEEK base cell in the workbook. A homeschool or private-school student generates no state funding for "
  "the district today, so each one who enrolls is entirely new money: $4,636 of SEEK a year, about "
  "$4,236 after supplies. At the full check, the 450 to 550 pool is $2.1 to $2.5 million a year the "
  "district is not collecting; net of supplies, the 236 students in this district's own homeschool files "
  "alone carry about $1.0 million a year and the full pool $1.9 to $2.3 million. Filling all 46 open "
  "seats at the rated 174 from this pool alone is worth about <b>$213,000 a year gross, roughly "
  "$134,000 to $194,000 net of supplies and the zero to one new section the v3.8 correction prices</b>, "
  "and requires fewer than one in five of the registered homeschoolers. The model's Redistricting tab "
  "carries a returning-student lever alongside the rezone and transfer levers, capped together at the "
  "70 seats between today's enrollment and the 198 rating the state approved in 2013 (today's 174 is "
  "not a ceiling), and set to zero by default so the separate rezone-and-transfer package, priced in "
  "Appendix B at $56,000 to $116,000, claims nothing from it. What would move these families is no "
  "mystery: the county's top test scores, the state's best-trending building, and small classes are "
  "exactly the product homeschool and private-school families shopped for when they left. Two records "
  "asks sharpen this: the letter-of-intent counts by year at both districts, which are public records, "
  "and the school-level split of the 131 out-of-county students already here. Closing the school with "
  "the open seats forfeits the one asset this recruitment case runs on.")
...
P("Bourbon County Schools has a structural funding problem: spending has outrun revenue at every "
  ...
  "median outcome loses $534,433 a year. Together they balance the budget, end the sweep, free the "
...
P("And the surplus is transformative. The website's plan calculator prices the enrollment lever "
  "directly: recovered leakage students, zero to the full measured pool of 550, each at the same $4,236 "
  ...
  "cancel in the gap; the audit will refine it; the audited fiscal 2025 gap was $2,648,086; Section 8 "
  "walks the packet line by line, and the sequencing discussion uses the related $1,694,928 "
  "close-plus-sweep requirement). One caution carries over from Section 8: the trend counts the "
  "unidentified $1.4 million June receipt. If that receipt does not recur the gap runs toward $3.1 "
  "million, which the plan's middle and top cases clear and its floor does not. With the cost package "
  "at its low end, the full 2018 restore, and not one student recovered, the plan clears the trending "
  "gap with about $500,000 a year to spare, within $7,000 of funding the full 5 percent raise for every "
  "certified teacher, about $507,000 a year on the district's own $10.0 million General Fund certified "
  "payroll. Two recovered students close the difference, and every dollar of the deeper cost package "
  "lands on top. The calculator opens at the central case, half the pool recovered: 275 of 550 students "
  "at the same $4,236 add $1,164,900 a year, the plan runs about $1.66 million ahead, and after the "
  "raise about $1.16 million services roughly $15.1 million of new bonds, about $47 million of capacity "
  "with the advisor's $32 million. At the sliders' top, the full 550-student pool with every lever "
  "high, the plan runs about $3.4 million ahead: the raise plus roughly $37 million of new bonds, about "
  "$69 million of capacity. Every 100 recovered students move the number by $423,600 a year in either "
  "direction. The capacity is the district's own advisor's $32 million rating, real only once the sweep "
  "ends, because the sweep spends the very stream the capacity is built on. Together: teachers paid "
  "more, real building capacity, every school open. The earlier 10-percent-raise and $52 million "
  "top-end claims are withdrawn with the lever correction.")
P("A suggestion for running the plan: the board should create three standing committees, one per lever, "
  ...
  "rate. Committees commit no new money, and they turn a plan on paper into work with names on it. "
  "Volunteers from the North Middletown community stand at the ready to serve on all three.")
...
P("The growth side is priced with the same discipline as the closure grid, on the district's own "
  "standards. The anchor is its own Appendix B: 24 students per room in kindergarten through grade 3, 28 "
  "in fourth, 29 in fifth. Applied to the school's actual grade counts, the six homerooms hold 153 "
  ...
  "one classroom teacher per full new class, at a selectable pace with every setting a real classroom "
  "count: 1 per 18 (smaller classes than today), 1 per 21 (today's actual class size), or 1 per 24 (the "
  "district's own K-3 cap). Support staff is priced on its own lever, none, 1 per 75, or 1 per 50 added "
  ...
  "$1,000 legs the closure grid prices for each leaver, so the two models treat add-ons symmetrically. "
  "The supplies figure is symmetric too: the closure grid credits each missing student with the same "
  "$400 of supplies the growth grid charges each recruit. No lever double-counts staffing: teacher "
  "changes are priced only on each grid's own teacher lever.")
P("The result: across all 19,683 priced scenarios, growth pays in every single one. Under the same "
  ...
  "documented central reads; uniform on the enrollment target, which is the board's choice, not a "
  "chance), the median gains $142,220 a year and the middle half runs from $94,720 to $183,354. Even "
  "the worst case, a class of 18 at the top salary with every cost at its maximum, still nets $4,131. "
  "The website's calculator opens at 30 added students, $142,080, within $140 of the weighted median (a "
  "target of 140 on the slider's 110 base, the district's own still-unsourced figure; the same 30 added "
  "to the official 128 count is a target of 158), no new hires needed, $142,080 a year (the district's "
  "own Appendix B caps leave 25 open seats across the six grades; adding 30 leaves five over unless "
  "enrollment lands unevenly, and the calculator's hiring lever prices the section the caps would "
  "force). The same stack drives the cost-per-student curve: at 160 students the school costs about "
  "$14,600 per student with no new hire yet needed, and at the 198 seats the state approved in 2013, "
  "with two new teachers paid for, about $12,500, cheaper than every school in the county today. One "
  "script, build/growth_grid.py, reproduces the whole grid.")
...
P("The rate history strengthens the community's hand. Bourbon County Schools levies 52.4 cents per $100 "
  ...
  "Montgomery is essentially tied at 52.5 (Figure 15). The trend runs the same direction. The levied "
  "rate has fallen from 61.3 cents in 2018 to 52.4 today, a decline that largely reflects Kentucky's "
  "rollback mechanics, in which a rising assessment base pushes the cent rate down to hold revenue "
  "roughly level. KDE's levied-type file, archived in this repository, shows the board took the full "
  "four percent revenue option in five of the last twelve years and the compensating rate or less in "
  "the other seven, the exact years the rate slid. The regional contrast is stark: Scott County rode "
...
P("What remains is the choice the board controls every August: the rate itself. The anchor of this "
  ...
  "of the annual reserve drawdown, and the next subsection walks why a board can take it every year "
  "while the printed rate still falls. (The restricted building-fund levy, which cannot pay operating "
  "costs, is excluded from this base, the same restricted-funds rule this report applies to closure.) "
  "Section 11 carries the recommendation and the companion workbook carries the math. The levy is one "
  "option, not the only one: the Figure 21 menu lists other revenue and cost measures, and deeper "
  "spending reductions are always available to a board willing to make them. But the math is simple and "
  "it does not bend. Either spending comes down or revenue goes up. A district drawing down a million "
  "dollars of reserves a year does not get to choose neither. The board and superintendent owe the "
  "public a chosen path, in writing, with the work shown. And the board deserves better than a single "
  "option: a full menu, both columns priced, is what this report puts in its hands.")
fig("chart_tax.png",
...
P("The fourteen-year record settles how unusual this county's levy path is. KDE publishes every "
  ...
  "decline in the region, falling from second highest among the nine in 2012 to eighth today, the "
  "second lowest. Two honesty notes belong in the reading. First, these are levied RATES: under House "
  "Bill 44 a rate can drift down while collections hold, because the compensating rate falls as "
  ...
  "drawdowns began. The neighbors that rose took the four percent seven, eight, and nine times over the "
  "same window. The community that has twice declined to petition against a facilities nickel has never "
  "been asked to vote against the operating levy that pays teachers; the board simply has not levied "
  "it.")
...
P("Two consequences follow. First, <b>a flat or falling rate is not evidence either way</b>; arguing "
  ...
  "assessment growth, raises about 9.2 percent more revenue, and every dollar above the four percent "
...
P("One movement in Figure 16 needs explaining. Bourbon's total levied rate rose 3.2 cents in tax year "
  ...
  "dates this board's recallable facilities nickel to August 17, 2023 and puts it at 5.7 cents, and a "
  "new 5.7-cent restricted levy inside a 3.2-cent net increase means the remainder of the rate fell "
  "about 2.5 cents the same year, roughly $415,000 a year of unrestricted revenue at the district's "
  "certified real-estate yield of about $166,000 per cent. KDE does not publish the year-by-year "
  "rate-type split, so the 2.5 cents is an inference from the current file rather than a document, and "
  "the certified split by year is requested for exactly that reason. The direction is not in doubt: the "
...
P("The four percent revenue growth is the most the board can collect without offering voters a veto. It "
  ...
  "how every neighboring district in Figure 16 climbed past Bourbon. Each option below is priced at the "
  "certified real estate base in the fiscal 2025 audit: the $1,843,569,625 total valuation splits, on "
  "the audit's own calculated levy of $9,880,143 at 52.4 real and 64.5 tangible cents, into "
  "$1,661,885,191 of real estate and $181,684,434 of tangible property, so one cent on real estate "
...
P("Restoring the rate this district itself levied in 2018 closes about two thirds of the structural gap "
  ...
  "because ending the sweep is what frees the restricted building stream to carry bonds. Restoring the "
  "2018 rate raises about $1,479,000 (8.9 cents on the certified real base), covering the operating "
  "close and most of the sweep on its own; the remaining $216,000 a year is well inside the cost "
  "package's $760,000 floor. An earlier version priced the restore at $1,699,479 by dividing all-class "
  "property collections by the real-estate cent count; that blended figure overstated a real-only rate "
  "move and is corrected here and in the version history. Once the General Fund stands alone, the "
  "nickel residual carries the $14 million renovation, the restricted capacity becomes genuinely "
  "pledgeable, and the phasing-in nickel equalization adds about $3.6 million more on top of the "
  "advisor's $32 million: roughly $35.6 million of construction capacity, corroborated in June 2026 by "
  "the district's own advisor rating current capacity at $32 million on the same restricted stream, for "
  ...
  "median options are honest partial steps; they leave about $814,000 and $382,000 a year still to find "
  "from the alternatives menu before the sweep can end.")
P("None of this is a recommendation of a particular number, and none of it is counted in the "
  "alternatives package of Section 10. The point is narrower: a menu of options exists between cut "
  "nothing and close a school, every one prices out larger than the most generous closure estimate, and "
  "every one carries a built-in democratic check. <b>A levy above four percent can be recalled by the "
...
P("The decision before the Board is often framed as closure versus no closure. That is the wrong frame. "
  ...
  "illustration on our stated assumptions, not a forecast; the Scenarios tab carries the math, one-time "
  "closure transition costs (unpublished) are not included, and two yardsticks run throughout: coverage "
  "percentages against the $2.65 million operating gap before transfers, balance projections against "
  "the roughly $1.15 million net drawdown after transfers.")
tbl(["Plan", "Recurring impact, year 3", "Projected FY2029 balance", "What it requires"],
    [["1. Districtwide status quo (change nothing)", "None", "Fully drawn down",
     ...
     ["2. Close NMES and consolidate", "-$1,020,613 to -$61,862 (median: LOSES $534,433)", "Median: gone much sooner than status quo",
    ...
    caption="Three complete plans, compared on the same assumptions. At the closure grid's median, Plan 2 drains "
            "reserves faster than doing nothing; even its best case loses $61,862 a year, and every priced "
...
P("<b>One:</b> keep the school Permanent in the facility plan with its capital needs at lower priority; "
  ...
  "<b>Four:</b> state publicly that the district will work to grow this school, because uncertainty is "
  "its own enrollment killer and a sentence of commitment gives families the confidence to enroll. The "
  "honesty behind these asks is already in the district's books: if staff are reassigned rather than "
  "cut, a closure frees the $79,211 of building costs in its own ledger, and the restricted renovation "
  "money is capped by enrollment regardless, a ceiling that rises with every recruited student. A "
  "closed school cannot be recalled by the children it displaces; a growth plan can be measured, every "
  "year, by everyone.")
asktext = ("<b>The ask, plainly stated:</b> the community requests that the Board of Education pause any vote on "
           ...
           "public. A pause is fully within the Board's power: boards control their own agendas, a resolution "
           "deferring adoption requires only a majority, and if the four-year planning deadline presses, the "
           "Board can ask the Kentucky Department of Education in writing for additional time under the "
           "facilities-planning framework (702 KAR 4:180 and its incorporated manual), a question that costs "
           "nothing to ask. Nothing in state law forces a rushed decision.")
...
P("We built this report from public records and Open Records Requests only, and we want it held to that "
  ...
  "panel is SchoolDigger's normalized 0-100 rendering of state test data, a consistent yardstick but not "
  "KDE's official rating; where this report says first in every tested subject, that is the state's own "
  ...
  "figures directly. Every dollar range labeled an estimate is ours, its assumptions are stated where it "
  "appears, and every one is adjustable in the companion workbook. The boundary rebalancing scenario in "
  "the appendix is simple math on the cited enrollment counts, not a routing study; the transportation "
  "estimates beside it use the official federal zone boundaries (SABS, 2015-16), a highway distance, and "
  "labeled cost-per-mile bands, and the district's annual T-1 transportation report would replace the "
  "cost inputs.", note)
P("A few items in the record need the district, not us, to resolve. The real-estate tax rate appears "
  "three ways in public records, as 52.4, 54.2, and 54.7 cents; Section 10 resolves it: 52.4 cents is "
  "the levied rate, 54.2 a transposition typo, 54.7 the motor vehicle rate. The cent split (41.0 General "
  "Fund plus two 5.7 nickels) and the levied rate type by year are now settled from KDE's own files, "
  "archived in this repository; still open is the pre-2012 rate history, in state files the district can "
  "produce. The 2013R bond figures are internally inconsistent as printed. The 2024 bond's stated "
  "purpose is now on the public record through the state's June 2024 bond disclosure (high school roof "
  "and a districtwide audio system); the 2023 issue's project detail and both years' BG-1 applications "
  "are still open. The school-level climate and safety survey results were not publicly retrievable. And "
  "the enrollment count itself: federal data show 128, public statements have said around 100, and a 118 "
  "figure appears in no official record we could find. Reported free and reduced-price meal shares for "
  "the school range from roughly 76 to 93 percent across federal and state sources. The recollection in "
  "Section 6 of an earlier transitional episode is Dr. Bradley's, from personal discussions with his "
  "father, who served as mayor of North Middletown; it is offered as memory, and the pre-2021 planning "
  "records that would confirm it remain a public-records request away. One more for the record: the "
  "fiscal 2025 audit misprints the prior year's attendance as 2,278.527; the correct figure, 2,278.537, "
  "comes from the fiscal 2024 audit itself.", note)
...
P("<b>Version 5.0, August 17.</b> The school-choice survey results are published, anonymized, and the "
  ...
  "of 128 (0 to 64 students) to survey-anchored students missing from the rolls at steady state (129 to "
  "187: the statistical band's 25th, 50th, and 75th percentiles, triangular; the floor of 74 from signed "
  ...
  "never counted twice; the busing high leg is capped at half its bottom-up maximum, $95,000, and a "
  ...
  "a $534,433 yearly loss, the middle half to a $643,405-to-$429,974 loss, every priced scenario loses "
  "money (the best case still loses $61,862), and the website default (the savings that scale with "
  "students granted, teachers included, half the fixed overhead cut, median leavers) opens at a $418,495 "
  ...
  "scenario count is the direct result of inputs the survey and records responses pinned down. The response-bias factor is recentered from 3x to 3.5x, the high end of the published measurements, chosen for a small, emotionally charged respondent pool, and every survey-derived figure is re-based. The "
...
P("The remaining process is set by state regulation (702 KAR 4:180 and the Kentucky School Facilities "
  "Planning Manual). After the committee finishes its draft, the plan goes to the Kentucky Department of "
  "Education for review, returns to the committee for a vote, must be adopted by the local Board of "
  "Education, is subject to a formal public hearing, and finally requires approval by the Kentucky Board "
  "of Education. A \u201ctransitional\u201d label is a planning classification, not a closure: no school closes "
...
P("Three facts fall out of that table. First, North Middletown's rated capacity was written down from "
  ...
  "facility” (sections 302.2.2 and 302.3.1). A fair question for the plan's documentation, a question "
  "rather than an accusation: under that provision, what changed at each building to move the ratings? "
  "Rated capacity is a number the district sets through its own room assignments, and it can be raised "
  "the same way it was lowered: the same pencil that makes space for 128 more children in Paris can "
  "raise North Middletown's rating back toward the 198 it carried in 2013. Second, as recently as the "
...
P("The architect's slides are one reading of the building. The state publishes its own, and it is "
  ...
  "Condition Index: one minus the ratio of repairs coming due within four years to the cost of replacing "
  "the building outright, so a higher number means a healthier building. KDE has published exactly three "
  "statewide reports: October 2023, October 2025 (both resting on inspections done in 2020 and early "
  "2021, with costs updated between them), and an updated report generated July 2, 2026 that carries the "
...
P("Three findings sit in that figure. First, in the newest KDE-reviewed data, North Middletown's "
  ...
  "index counts what is due within four years. On either reading NMES is near the bottom of the "
  "district's need list. One caveat favors caution rather than the closure case: NMES's Educational "
  "Suitability score, the separate survey of how well the 1948 layout matches modern program "
  "standards, prints 0.21725 in the July 2026 report, identical to five decimal places to the 2023 "
  "report. That half of the score appears carried forward rather than re-surveyed in April 2026 even "
  "as the condition half was refreshed. Whether it was re-surveyed is for the district and its "
  "architect to answer on the record; the identical figure may have an innocent explanation, and the "
  "ask is simply to state it. On the state's newest data, the building proposed for closure is the "
  "only one whose condition improved, carries the smallest near-term repair bill of the five, and "
  "scores above a receiving school 44 years its junior.")
...
P("One scenario, run in the workbook's Redistricting tab. Rezone 30 students to North Middletown from "
  "the adjacent edges of the Cane Ridge and Bourbon Central zones, drawing only from families who "
  "already live closer to North Middletown than to their assigned school, and recruit 16 cross-county "
  "transfers under House Bill 563. The school reaches exactly its rated 174; Bourbon Central eases to "
  "about 444 and Cane Ridge to about 438. Priced honestly, grade by grade: the class caps (KRS 157.360) "
  "bind grade by grade, not on average, so 46 arrivals likely require one new section, possibly two if "
  "they lump in the wrong grades and possibly none if the rezone is drawn grade-by-grade; the "
  "Redistricting tab carries that lever at the same $60,000 General Fund rate this report applies to "
  "eliminated positions. The 16 transfers bring roughly $74,000 a year of new SEEK revenue, supplies for "
  "all 46 added students cost about $18,000, and with one added section against one to two avoided at "
  "the receiving schools the package is worth roughly <b>$56,000 to $116,000 a year, recurring</b>, down "
  "from the $116,000 to $176,000 published before this correction. The move cuts the school's much-cited "
  "cost per student from $19,348 to about $14,827 with the added section, purely by filling seats. Two "
  "assumptions are flagged in yellow for the district to replace with real data: that rezoned students' "
  "routes shorten because they are chosen by proximity, and the receiving schools' grade-by-grade "
  "capacities. The July 2026 records response produced the current bus routes but answered N/A for GIS "
...
P("The zone geometry here is official: the federal School Attendance Boundary Survey (2015-16, the last "
  ...
  "where density is low because low density costs more to serve. The funding history sharpens the "
  "point: the formula ran underfunded for two decades, the 2024-2026 state budget restored it to 90 and "
  "then 100 percent, computed on lagged fiscal 2023 costs, and the 2026-2028 budget froze it again "
  "below the statute. A district that closes its one eastern school keeps every square mile of that "
  "coverage area and serves it with longer rides.")
...
P("The savings from doing this well are documented. Boston Public Schools ran the signature version in "
  ...
  "shows the ceiling sits higher than the menu assumes. One more check anyone can run: the federal "
  "School Attendance Boundary Survey published the district's attendance-zone boundaries as free GIS "
  "files, and Figure 20 is drawn directly from that file, fetched by the repository's "
...
P("The July 2026 records response settled the central question of our records asks: asked for any "
  ...
  "should run line by line: the net recurring General Fund saving, meaning costs that truly disappear, "
  "minus added transportation, receiving-school costs, and the carrying or disposal cost of the "
  "building, with the downside beside it. A worksheet carrying only one side of the ledger is not a "
  ...
  "base with them, $4,636 at the fiscal 2027 rate, every year, permanently; ten students is $46,260 a "
  ...
  "funds every school in the county? The limits of our evidence belong in the question: the thirty-year "
  "Kentucky corpus in Section 5 does not establish that closure causes decline, because small towns "
  "that kept their schools declined at nearly the same rate. So this is not a claim. It is a risk, it "
