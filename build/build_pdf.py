...
P("Read the two districts side by side and the lesson is runway rather than virtue, and the basis matters. "
  "Bourbon's fund balance fell $1,225,465 last year, about <b>4.2 cents per dollar spent</b>, but only after "
  ...
  "district ran <b>9.1 cents in the red</b>. That is the planning number, because this report's own plan ends "
  "the sweep: ending it is what frees the restricted stream to carry bonds. Measured that way the 14.7-cent "
  "cushion is about <b>a year and a half</b>, not the three and a half the net change implies. Fayette on the "
  "same basis ran 5.7 cents of operating gap against a 4.1-cent cushion, well under a year, and on Weaver's "
  "unaudited view its cushion is nearer one cent; it has approved borrowing up to $95 million to reach fall "
  "tax collections. Bourbon still has more room than Fayette, and less than the net figures make it look. Bourbon is not Fayette. It is pointed the same direction with time still on the "
