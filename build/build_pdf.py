...
P("North Middletown's $19,348 per student is the highest of the three elementaries. That is exactly "
  ...
  "allocated figure, not a site ledger: about $1.0 million of it is central office, district "
  "transportation and district instructional support that no closure removes, reconciled line by line "
  "in the ledger walk below. (The report's $19,348 rate at the 135 students then reported; at today's "
  "128 the same rate gives the $2,476,544 the cost case rests on.) And almost none of that total is what a "
...
P("First, the staffing price. $85,000 is the right all-in figure for comparing spending filings but "
  "the wrong one for the General Fund: Kentucky pays teacher retirement and health insurance on behalf "
  "of districts, so the fund keeps only salary plus roughly five percent when a position goes away, "
  "<b>$50,000 to $75,000 per position, not $85,000</b>. We go further: every staffing lever is priced "
  "at the district's own fully loaded figure, <b>$54,479.40 per position</b>, from Appendix A.1 of its "
  "written response. Their number, their basis.")
P("The grid is built on the district's 48-page response and the community's survey. Six levers, each "
  ...
  "supplies that stop, the same figure the growth model charges each recruit. One mechanic: SEEK pays "
  "on the prior year's average daily attendance, about 91 percent of end-of-year enrollment here, so "
  "the base alone prices a leaver near $4,200, and the formula's at-risk, exceptional-child, language, "
  "and transportation weights, mostly uncounted in our $500 add-on, are worth roughly $1,000 to $2,200 "
  "more per student on the district's own KDE file. The price leans low. Teacher savings appear "
...
P("Their named destinations are real and open today: Montgomery County, Clark County, homeschool, "
  "private school. The survey is read as a share of the school, not as per-class counts, a v5.0 method "
  "change disclosed in the version history. A child who leaves is missing for every remaining grade. The district's "
...
P("The statistical estimate corrects the survey for the obvious bias: families set on leaving answer a "
  ...
  "benchmark studies (2012, 2017) find civically engaged people over-represented at implied ratios of "
  "roughly 3 to 4. The model's 3.3x-to-9x span starts in the top half of that measured band, 1.4x to "
  "4x, and runs far past it, because a small, emotionally charged pool answering a zero-effort form "
  "circulated by the campaign itself is where this bias runs strongest. The model leans against its "
  "own survey.")
...
P("Two conclusions follow. First, the closure model estimated the school's avoidable fixed base at "
  ...
  "<b>$293,316</b> ($276,928 on the budget view): both estimates within seven percent of the measured "
  "record. Second, <b>$230,000 is the floor of the grid, not a floor case</b>: "
  "reaching it requires the principal, the secretary, the custodian and the utilities all to go, and "
  "districts frequently redeploy people rather than cut them. Version 3.9 rebuilt the grid on "
  "measured fixed lines, moving the median from $91,240 to $21,571. Version 4.2 rebuilt it on the "
  "district's own written response, all current staff retained, savings only through attrition, "
  "avoidable expense lines of $107,039 plus $20,000 of insurance, and the median flipped negative. "
  "Version 4.5 added the lever weights above and re-based the fixed-position lever on the ledger's "
  "FY2026 actuals ($214,104 against the budget's $218,154): a $20,007 median yearly loss, 55 percent "
