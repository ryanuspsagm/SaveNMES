...
fig("chart_pptime.png",
    ...
    "adding $400 of supplies per added student. Staffing is priced, not assumed away: nine rooms average 19 "
    "students at 174, but KRS 157.360 caps K-3 rooms at 24, so an even grade mix would need about two added "
    "sections at 174 or one at 154. Priced at the full $85,000 loaded cost each, the filled school lands at "
    "$15,316 and $16,701, still the cheapest of the three in current costs. Read honestly, the dashed lines say two things. In the "
    "pandemic-aid years a filled school would have run within 1 to 3 percent of the other two, a tie, not a "
    "saving. In the district's current cost structure it is decisively cheapest: $14,339 per student in 2023-24 "
    "at the approved 174 rating, and $16,149 even at the 154 rating the 2026 draft proposes, against $18,131 and "
    "$18,670 at the receiving schools. The lower dashed line starts in 2021-22 because before that the school's "
    "actual enrollment, 166 and then 160, exceeded the 154 capacity the draft plan now assigns it. The workbook's "
    "Redistricting tab carries the break-even test: the result holds even if each added student cost the school's entire "
...
P("Put together, my best honest estimate of the net recurring General Fund saving is roughly <b>$250,000 to "
