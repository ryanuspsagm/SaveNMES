...
P("A note on the transfers line, because it changes how the numbers look, not the math itself: "
...
P("Five years of the district's own filings say the same thing in time series: North Middletown's total site "
  ...
  "$3,300 to $3,800 under either receiving school, and the students who fill it come from the exact schools that are over "
...
P("Two conclusions follow, and the second is a caution about this report's own model. First, the closure "
  ...
  "The old grid contained no such scenario, which meant every figure this report published assumed the "
  "district would make the deepest cut available to it. <b>So this version rebuilds the grid.</b> The "
  "fixed-cost lever now carries the three decisions the district can actually make with these lines, all "
  "measured rather than estimated: staff reassigned and utilities only, $58,774; mothballed with those "
  "positions cut, $227,831; sold, adding the library and media line, $276,928. The grid goes from 1,944 "
  "combinations to 2,916. It is the largest correction in this release and it moves the headline against "
  "this report's own case: the median saving falls from $91,240 to $21,571, the negative share rises from 29 "
  "to 45 percent, and the range widens to minus $556,006 and plus $551,928. One question to the district "
  "would narrow all of it: which of these positions would be eliminated, and which reassigned?")
...
P("<b>First, the money.</b> For the 163 closure events with clean finance data, I compared each district's "
  ...
  "year). Here the two methods bracket rather than coincide, and this version says so plainly because the "
  "v3.9 grid rebuild moved this report's own number and not the record's. Thirty years of budget outcomes "
  "put the plausible median at $818 per displaced student. This report's bottom-up model, built without ever "
  "looking at that history, now puts its median at $169, down from $713 before the fixed-cost lever was "
  "rebuilt on the district's measured lines. They are not the same number and they do not measure the same "
  "thing: the record's figure credits a district's entire budget change to its closure, an upper bound by "
  "construction, while the bottom-up figure prices only the levers a closure actually moves. What matters is "
  "that both sit far below the yardstick. The plan needs $6,250 to $7,813 per displaced child: eight times "
  "the record's generous reading, and thirty-seven times this report's own.")
P("What a reader should take from the pair is not a single number but a ceiling. The record's $818 is what "
  "thirty years of Kentucky districts actually managed when every dollar of their budget improvement is "
  "credited to the closure, which no honest accounting would do. The bottom-up $169 is what the seven "
  "priced levers deliver at the middle of each. Between them lies every defensible answer, and the plan's "
  "requirement lies well outside. That gap, rather than any one estimate, is the finding: a closure of this "
  "school cannot produce what the plan needs from it, and no arrangement of the inputs makes it do so.")
...
P("<b>Second, the classrooms.</b> Test scores can only be compared within one accountability system, so I "
  ...
  "Kentucky's broad mid-decade testing rebound, gains far too large for schools that were one to eight "
  "percent of their districts to explain. Exactly <b>one</b> event in the record shows both clear savings "
  "and clear gains: Leslie County 2013, which folded its middle school into an existing campus in the same "
  "community. No case exists of a district closing a rural town's elementary school, clearly saving money, "
  "and clearly improving scores.")
...
P("The costs to children pile on top of the costs to the budget: a 2024 national study following 470 Texas closures found displaced "
  ...
  "math.")
P("When the district shows its numbers in public, watch four ways it can frame them, because "
...
P("The cost argument rests on one recent number, so this version assembles every school-level cost figure "
  "that exists in any state or federal record: three reporting systems reaching back a quarter century, each "
  "archived in the repository. The oldest are the 2000-01 state report cards, recovered from the Internet "
  "Archive, and they show all four of the district's then-elementaries on a single scale curve: about $2,851 "
  "per student plus a fixed base of about $332,000 per building spread over however many children the zone "
  "lines assign to it. That one formula predicts every school within 4 percent: Bourbon Central $3,360 "
  "reported at 595 students, Cane Ridge $4,053 at 312, North Middletown $4,414 at 193, Millersburg $5,200 at "
  "145. No school on that list was mismanaged; the ranking is enrollment, and Cane Ridge itself cost 21 "
  "percent more than Bourbon Central for the same scale reason North Middletown cost 31 percent more. The "
  "cheapest school in the county has always simply been its biggest.")
...
P("The details underneath the headline numbers are worth a closer look. In 2023-24 North Middletown matched the "
...
P("The fresh architect-and-engineer assessment this cycle rests on has now surfaced: the KFICS Facilities "
  ...
  "bonding capacity in Section 6. So the assessment answers one question and raises a better one: closing "
...
fig("chart_condition.png",
    ...
    "district 041.")
P("Three findings sit in that figure. First, in the newest KDE-reviewed data, North Middletown's condition "
  "index is <b>0.773</b>: better than Cane Ridge (0.728), within six points of Bourbon Central (0.823), and "
  "far ahead of the middle school (0.596), the district's other 1948 building. Second, North Middletown is "
  "the <b>only school in the district whose condition improved</b> between the 2020-21 and April 2026 "
  "inspection cycles, from 0.694 to 0.773, while every other school's index fell or held: the repairs coming "
  "due within four years at NMES dropped from about $4.1 million to <b>$3.1 million, the smallest four-year "
  "repair bill of the district's five schools</b>. Cane Ridge, a 1992 building, moved the other way, from "
  "0.812 to 0.728 with a $4.8 million four-year bill. Third, the numbers reconcile with the architect's own "
  "$8.5 million total-need figure for NMES quoted above: that larger total includes longer-horizon work and "
  "$2.9 million of instructional-space items, while the condition index counts what is actually due within "
  "four years. On either reading NMES is near the bottom of the district's need list. One caveat belongs in "
  "the record, and it favors caution rather than the closure case: NMES's Educational Suitability score, the "
  "separate survey of how well the 1948 layout matches modern program standards, prints 0.21725 in the July "
  "2026 report, identical to five decimal places to the 2023 report, so that half of the aggregate score "
  "appears to have been carried forward rather than re-surveyed in April 2026 even as the condition half was "
  "refreshed. The building the draft plan proposes to close is, on the state's newest published data, the "
  "healthiest small asset the district owns: best trend in the county, smallest near-term repair bill, and a "
  "condition index that beats a receiving school 44 years its junior.")
...
P("I deliberately rely on the audited totals rather than individual salaries, because individual "
  ...
  "current and for the past five years, is exactly the kind of openness this moment calls for, and appears among the "
...
P("Here is one concrete scenario, math anyone can check, run in the workbook's Redistricting tab. Rezone "
  ...
  "$74,000 a year of new SEEK revenue, supplies for all 46 added students cost about $18,000, and with one "
  "added section against one to two avoided or redeployed at the receiving schools as the Paris side grows, "
  "the package is worth roughly <b>$56,000 to $116,000 a year, recurring</b>, down from the $116,000 to "
  "$176,000 published before this correction; across the two section sliders, at this example's student "
  "mix, it runs from minus $64,000 to $176,000. The move still cuts North Middletown's much-cited cost per student from $19,348 to about "
  "$14,827 with the added section ($14,339 without, $15,316 with two), purely by filling seats. Two assumptions are flagged in yellow in the "
...
P("Name the problem correctly and the plan writes itself. Bourbon County Schools has a structural funding "
  "problem: spending has outrun revenue at every building, salaries are hard to raise, and capital projects "
  "wait, and North Middletown is being blamed for it. The numbers in this report say otherwise. North "
  "Middletown is not the reason salaries cannot increase; its honest excess cost is about $156,000 a year against "
  "the cheaper receiving school ($121,220 on the district's own KDE-filed comparison to the peer average), "
  "six tenths of one percent of the budget. North Middletown is not the reason capital projects cannot be "
  "funded; roughly $17.6 million of restricted bonding capacity sits unused while the capital-to-operations "
  "sweep drains the building fund, and that sweep is a General Fund problem every school shares. A district "
  "in a defensive crouch, cutting a rural community's school to buy months, is choosing the smallest lever "
  "on the table and the only one that harms a town. Organized as a plan, the same menu above prices out as "
  "three moves. <b>Move one, inspect fixed costs, starting with administration</b>: central-office restraint, "
  "attrition-based staffing alignment, transportation and energy efficiency, shared services, and "
  "reimbursement recovery, worth $960,000 to $1.9 million a year. <b>Move two, grow enrollment instead of "
  "shrinking it</b>: fill North Middletown's 46 seats, recover attendance, and recruit district-wide from the "
  "measured pool of homeschool, private-school, and nonresident families with real incentives, worth "
  "$260,000 to $530,000 a year. <b>Move three, have the honest revenue conversation</b>: the four percent "
  "option and delinquency recovery bring $370,000 to $495,000 in year one and about $1.0 to $1.1 million by "
  "year three as the option compounds, and the recallable menu beyond four percent, each option priced with "
  "its cost to the median home, reaches $1.0 to $2.5 million. The three moves are the raw $1.6 to $2.9 "
  "million shown under Figure 19, cut to the published $1.1 to $2.1 million after overlap and implementation "
  "risk, and any one of them alone outweighs the closure median of $21,571 many times over. Together they balance the "
  "budget, end the sweep, free the restricted stream to bond the renovation plan, and close nothing. That is "
  "the difference between a defensive posture and a growth plan, and the choice belongs to the board. The "
  "Alternatives tab prices each move live.")
...
P("Corrections in version 3.9. Ten, and five of them run against this report's own case. "
