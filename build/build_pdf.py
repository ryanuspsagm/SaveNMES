...
P("The students are not hypothetical, and the public record measures the pool three ways, all archived here. "
  ...
  "sit outside public school entirely, against nearer one in eleven a decade ago). St. Mary in Paris, the "
  "county's only private school, enrolls 96 students in the federal Private School Survey. Third, the "
...
P("<b>Version 4.5, August 2.</b> Both scenario grids now carry explicit lever distributions: triangular "
  ...
  "net-import framing was retired. A condensation pass closed the release: the opening was rewritten to mirror the "
